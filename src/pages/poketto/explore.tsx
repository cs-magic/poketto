...
export default function ExplorePage() {
  ...
  const query = api.flowgpt.listPoketto.useInfiniteQuery(
    { sort: sortOrder },
    {
  ...
  return (
    <RootLayout>
      ...
      <div
        className={clsx(
          "| flex h-full w-full max-w-[1360px] flex-col gap-4 overflow-auto p-4 lg:p-8"
        )}
      >
        {/*<HomeCarousel/>*/}
        ...
        {/* title */}
        <div
          className={"| flex w-full items-center gap-2 whitespace-nowrap px-2 "}
        >
          <FrameIcon />
          ...
          <div className={"flex items-center"}>
            {Object.values(FlowGPTSortOrder).map((order) => {
        ...
        {query.hasNextPage === false ? ( // note: 显式指明
          <div
            className={
              "| | m-auto flex w-80 items-center justify-center bg-destructive p-4 text-center text-destructive-foreground"
            }
          >
