...
export const order2icon: Record<FlowGPTSortOrder, JSX.ElementType> = {
	[FlowGPTSortOrder.recommended]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconStackPush} {...props}/>, [FlowGPTSortOrder.top]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconThumbUp} {...props}/>, [FlowGPTSortOrder.mostSaved]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconDownload} {...props}/>, [FlowGPTSortOrder.trending]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconTrendingUp} {...props}/>, [FlowGPTSortOrder.new]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconCalendarFilled} {...props}/>, [FlowGPTSortOrder.follow]: (props: TablerIconsProps) =>
		<TablerIconFactory Comp={IconTelescope} {...props}/>,
}
export const Icons = {
	logo: (props: SVGProps) => <SVGFactory Comp={Logo} presetClassName={'bg-black text-white'} {...props}/>, csCoin: (props: SVGProps) =>
		<SVGFactory Comp={CSCoin} {...props}/>, openchat: (props: SVGProps) => <SVGFactory Comp={OpenchatIcon}  {...props}/>, midjourney: (props: SVGProps) =>
		<SVGFactory Comp={MidjourneyIcon}  {...props}/>,
}

const interFont = Inter({ subsets: ['latin'] })
export const font = localFont({
	src: [// { path: '../../public/fonts/weilaiyinghei/GlowSansSC-Normal-v0.93/GlowSansSC-Normal-Thin.otf', weight: '100', style: 'normal' },
