...
export const DEVICE_TYPES = ['the-iphone', 'iphone-x', 'iphone-14-pro', 'ipad-pro', 'surface-pro-2017', 'macbook-pro', 'imac', 'imac-pro'] as const
...
export const DEVICES: Record<DEVICE_TYPE, IDevice> = {
	'the-iphone': { w: 320, h: 610 }, 'iphone-x': { w: 428, h: 868 }, 'iphone-14-pro': { w: 428, h: 868, r: 68 },
	
	'ipad-pro': { w: 560, h: 778 }, 'surface-pro-2017': { w: 561, h: 394, r: 10 },
	
	'macbook-pro': { w: 740, h: 434 }, 'imac': { w: 640, h: 540 }, 'imac-pro': { w: 624, h: 484, r: 18 },
}
...
export const URI = {
	app: {
		home: '/', explore: '/poketto/explore', pocketApp: '/p', docs: {
			intro: '/docs/whats-poketto', currency: '/docs/whats-dora', learn: '/docs/learn', support: '/docs/support',
		},
	}, user: {
		dashboard: '/poketto/user/dashboard', gallery: '/poketto/user/gallery', integrations: '/poketto/user/integrations',
		
		auth: {
			signin: '/api/auth/signin', login: '/auth/login', register: '/auth/register',
		},
		
		seek: {
			waitlist: '/poketto/seek/waitlist', enterprise: '/poketto/seek/enterprise',
		},
	}, images: {
		favicon: '/favicon.ico', AiMap: '/images/bg/ai-anatomy-map@0.5x-裁切版.jpg', explore: '/images/mj/home-cover.png', carousal: {
			explore: '/images/mj/carousel-explore.jpg', competition: '/images/mj/carousel-peace.jpg',
		},
	},
}

export const CAROUSELS = [// { src: uri.images.AiMap, /* 色调太白了，不会让人喜欢的 */ title: 'AIGC 魔法能力评测' },
	{ src: URI.images.carousal.explore, title: 'AIGC 入门指引' }, { src: URI.images.carousal.competition, title: 'ChatGPT Prompt 对抗赛' }]
...
export const YourSolePokettoAppWithRelation: AppWithRelation = {
	...YourSolePokettoApp, model: {
		...
		id: nanoid(), createdAt: POKETTO_APP_CREATED_AT, updatedAt: POKETTO_APP_UPDATED_AT, userId: POKETTO_CREATOR_ID, content: 'This is a dedicated and developing app, hope helped you. Best wishes, Poketto Team.', title: 'Your Sole Poketto !', rate: 5, appId: POKETTO_APP_ID,
	}],
}
