...
export const Sidebar = () => {
	return (
		<div className={'h-full w-52 p-2 py-2 | flex flex-col gap-4'}>
			...
			<NavGroups title={'广场'}>
				<IconTitleLine icon={<IconCategory/>} title={'首页'}/>
				<IconTitleLine icon={<IconWorldCode/>} title={'发现'}/>
				<IconTitleLine icon={<IconPlug/>} title={'插件'}/>
			</NavGroups>
			
			<Separator className={'w-full'}/>
			<NavGroups title={'我的空间'}>
				<IconTitleLine icon={<IconUsers/>} title={'我的关注'}/>
				<IconTitleLine icon={<IconHistory/>} title={'历史记录'}/>
				<IconTitleLine icon={<IconVectorTriangle/>} title={'星空图'}/>
			</NavGroups>
