...
export const ConversationFindManyArgsSchema: z.ZodType<Omit<Prisma.ConversationFindManyArgs, "select" | "include">> = z.object({
...
export default ConversationFindManyArgsSchema;
