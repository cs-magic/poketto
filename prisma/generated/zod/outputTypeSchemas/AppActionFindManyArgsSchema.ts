...
export const AppActionFindManyArgsSchema: z.ZodType<Omit<Prisma.AppActionFindManyArgs, "select" | "include">> = z.object({
...
export default AppActionFindManyArgsSchema;
