...
export const StarringAppFindFirstArgsSchema: z.ZodType<Omit<Prisma.StarringAppFindFirstArgs, "select" | "include">> = z.object({
...
export default StarringAppFindFirstArgsSchema;
