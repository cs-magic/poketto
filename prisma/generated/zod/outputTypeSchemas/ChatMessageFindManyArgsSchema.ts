...
export const ChatMessageFindManyArgsSchema: z.ZodType<Omit<Prisma.ChatMessageFindManyArgs, "select" | "include">> = z.object({
...
export default ChatMessageFindManyArgsSchema;
