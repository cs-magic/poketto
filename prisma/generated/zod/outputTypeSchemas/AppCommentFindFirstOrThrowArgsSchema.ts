...
export const AppCommentFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.AppCommentFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default AppCommentFindFirstOrThrowArgsSchema;
