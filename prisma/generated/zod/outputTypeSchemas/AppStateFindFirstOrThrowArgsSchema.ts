...
export const AppStateFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.AppStateFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default AppStateFindFirstOrThrowArgsSchema;
