...
export const ChatMessageActionFindFirstArgsSchema: z.ZodType<Omit<Prisma.ChatMessageActionFindFirstArgs, "select" | "include">> = z.object({
...
export default ChatMessageActionFindFirstArgsSchema;
