...
export const InvitationRelationFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.InvitationRelationFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default InvitationRelationFindFirstOrThrowArgsSchema;
