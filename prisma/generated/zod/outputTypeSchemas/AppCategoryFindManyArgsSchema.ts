...
export const AppCategoryFindManyArgsSchema: z.ZodType<Omit<Prisma.AppCategoryFindManyArgs, "select" | "include">> = z.object({
...
export default AppCategoryFindManyArgsSchema;
