...
export const AppActionFindFirstArgsSchema: z.ZodType<Omit<Prisma.AppActionFindFirstArgs, "select" | "include">> = z.object({
...
export default AppActionFindFirstArgsSchema;
