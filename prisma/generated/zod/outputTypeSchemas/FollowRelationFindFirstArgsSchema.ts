...
export const FollowRelationFindFirstArgsSchema: z.ZodType<Omit<Prisma.FollowRelationFindFirstArgs, "select" | "include">> = z.object({
...
export default FollowRelationFindFirstArgsSchema;
