...
export const AppStateFindFirstArgsSchema: z.ZodType<Omit<Prisma.AppStateFindFirstArgs, "select" | "include">> = z.object({
...
export default AppStateFindFirstArgsSchema;
