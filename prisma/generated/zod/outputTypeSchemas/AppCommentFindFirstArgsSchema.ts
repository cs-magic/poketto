...
export const AppCommentFindFirstArgsSchema: z.ZodType<Omit<Prisma.AppCommentFindFirstArgs, "select" | "include">> = z.object({
...
export default AppCommentFindFirstArgsSchema;
