...
export const InvitationRelationFindManyArgsSchema: z.ZodType<Omit<Prisma.InvitationRelationFindManyArgs, "select" | "include">> = z.object({
...
export default InvitationRelationFindManyArgsSchema;
