...
export const ChatMessageActionFindManyArgsSchema: z.ZodType<Omit<Prisma.ChatMessageActionFindManyArgs, "select" | "include">> = z.object({
...
export default ChatMessageActionFindManyArgsSchema;
