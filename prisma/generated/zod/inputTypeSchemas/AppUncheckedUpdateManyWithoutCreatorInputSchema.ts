...
export const AppUncheckedUpdateManyWithoutCreatorInputSchema: z.ZodType<Prisma.AppUncheckedUpdateManyWithoutCreatorInput> = z.object({
  ...
  categoryMain: z.union([ z.number(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  categorySub: z.union([ z.number(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export default AppUncheckedUpdateManyWithoutCreatorInputSchema;
